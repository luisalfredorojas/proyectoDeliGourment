...
import {
  ...
  TextField, Button, Select, MenuItem, FormControl, InputLabel, Divider, Avatar, Alert, CircularProgress,
} from '@mui/material';
import { Close as CloseIcon, History as HistoryIcon, Send as SendIcon, Person as PersonIcon, AttachMoney as MoneyIcon } from '@mui/icons-material';
...
const ESTADO_LABELS: Record<TareaEstado, string> = {
  ...
  EMBALAJE: 'Embalaje', ENTREGADO_LOGISTICA: 'Entregado',
};
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            <Paper variant="outlined" sx={{ p: 2 }}>
              ...
              {tarea.estado !== TareaEstado.ENTREGADO_LOGISTICA && (
                <Box sx={{ mt: 2 }}>
                  <FormControl fullWidth size="small">
                    ...
                    >
                      ...
                      <MenuItem value={TareaEstado.ENTREGADO_LOGISTICA}>Entregado</MenuItem>
                    </Select>
                  </FormControl>
                </Box>
              )}
